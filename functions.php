 ...
 * Theme setup.
 */
function symbos_setup()
{
	add_theme_support('title-tag');

	register_nav_menus(
		array(
			'primary' => __('Primary Menu', 'symbos'),
		)
	);
...
add_action('after_setup_theme', 'symbos_setup');
 ...
 */
function symbos_enqueue_scripts()
{
	$theme = wp_get_theme();
 ...
 * @return array
 */
function symbos_nav_menu_add_li_class($classes, $item, $args, $depth)
{
...
add_filter('nav_menu_css_class', 'symbos_nav_menu_add_li_class', 10, 4);
 ...
 * @return array
 */
function symbos_nav_menu_add_submenu_class($classes, $args, $depth)
{
